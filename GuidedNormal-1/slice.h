...
public:
	...
	void GetContour(TriMesh &mesh, std::vector<int> &edges_status, TriMesh::HalfedgeHandle heh,double &height, Polylines &contour);//get contour from a intersected halfedge.
